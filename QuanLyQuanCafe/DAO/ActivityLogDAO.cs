...
namespace QuanLyQuanCafe.DAO
{
    public class ActivityLogDAO
    {
        ...
        public DataTable GetActivityLogListByDateAndPage(DateTime checkIn, DateTime checkOut, int pageNum)
        {
            return DataProvider.Instance.ExecuteQuery("exec USP_GetListActivityLogByDateAndPage @checkIn , @checkOut , @page",
                new object[] { checkIn, checkOut, pageNum });
        }
        public int GetNumActivityLogListByDate(DateTime checkIn, DateTime checkOut)
        {
            return (int)DataProvider.Instance.ExecuteScalar("exec USP_GetNumActivityLogByDate @checkIn , @checkOut",
