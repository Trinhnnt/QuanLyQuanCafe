...
namespace QuanLyQuanCafe
{
    public partial class AdminForm : Form
    {
        ...
        // RevenueReport
        private void LoadRevenueReport(DateTime fromDate, DateTime toDate, string groupBy)
        {
            try
            {
        ...
        private void GenerateRevenueReportButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                LoadRevenueReport(fromDate, toDate, groupBy);
            }
            catch (Exception ex)
            {
                MessageBox.Show("Lỗi khi tạo báo cáo: " + ex.Message);
